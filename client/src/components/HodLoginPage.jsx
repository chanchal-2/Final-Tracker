      ...
      <div className="flex-1 lg:ml-[48%] min-h-screen flex items-center justify-center bg-[#F8FAFC] px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center pt-2">
            <span className="text-[10px] font-semibold text-slate-400 bg-slate-100 border border-slate-200 px-4 py-2 rounded-full inline-block">
              💡 Demo: hod@tracker.com / password123
            </span>
          </div>
        </div>
      </div>
